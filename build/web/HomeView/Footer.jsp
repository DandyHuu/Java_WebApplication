<%-- 
    Document   : Footer
    Created on : Mar 4, 2019, 10:03:46 PM
    Author     : Dandy Huu
--%>
                        ...
                        <div class="ftco-footer-widget mb-4">
                            ...
                            <% for (clsBlog item : dsBlogRandFooter){%>
                                <div class="block-21 mb-4 d-flex">
                                  <a class="blog-img mr-4" style="background-image: url(Plugins/images/<%= item.getHinhanh()%>);"></a>
                                  <div class="text">
                                      <h3 class="heading"><a href="#"><%= item.getTieude()%></a></h3>
                                    <div class="meta">
                                      <div><a href="#"><span class="icon-calendar"></span> <%= item.getThoigian()%></a></div>
                                      <div><a href="#"><span class="icon-person"></span> <%= item.getNguoidang()%></a></div>
                                    </div>
                                  </div>
                                </div>
                                <%}%>
