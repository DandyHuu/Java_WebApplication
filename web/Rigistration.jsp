<%-- 
    Document   : Rigistration
    Created on : Mar 7, 2019, 11:50:46 AM
    Author     : Dandy Huu
--%>
                                    ...
                                    <dd style="<%=active_cr%>">
                                        <form class=" login" action="DangkyServlet" method="post" data-toggle="validator">
                                            ...
                                            <div class="form-group" id="user-result">
                                                <input onkeyup="HideAtt()" id="username" name="username" minlength="6" required="" data-error="Vui lòng nhập lại tài khoản (lớn hơn 6 kí tự)" type="text" class="form-control" placeholder="Tài khoản">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                             <p id ="err-p"  class=" text-danger"><%= username_err%></p>
                                            <div class="form-group">
