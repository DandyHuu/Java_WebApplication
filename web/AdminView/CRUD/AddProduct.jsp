<%-- 
    Document   : AddProduct
    Created on : Mar 21, 2019, 10:28:21 AM
    Author     : Dandy Huu
--%>
            ...
            try {
                ...
                //switch(fieldName)
                        ...
                        if (fieldName.equalsIgnoreCase("SpID")) {
                          ...
                          SpGia = Integer.parseInt(fi.getString());
...
//                             SpLoaimon = lm.LayIdCate(loaimon);
                ...
                clsMonan item = new clsMonan(SpID, SpName, SpMota, SpAnh, SpHot, SpNew, SpGia, SpLoaimon);
                
                boolean kq  = monan.ThemMonAn(item);
                if (kq == true) {
